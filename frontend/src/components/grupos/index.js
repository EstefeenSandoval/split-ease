// Archivo barrel para exportar todos los componentes de grupos
export { default as DetalleGrupo } from './DetalleGrupo/DetalleGrupo';
export { default as CrearGrupoForm } from './CrearGrupoForm/CrearGrupoForm';
export { default as EditarGrupoForm } from './EditarGrupoForm/EditarGrupoForm';
